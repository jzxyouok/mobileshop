					...
					<?= Collapse::widget([
						'items' => [
							...
							[
								'label' => 'Order',
								'content' => [
									'<a href="' . Url::toRoute(['order/list', 'status' => 'current']) . '">Existing Order</a>',
									'<a href="' . Url::toRoute(['order/list', 'status' => 'past']) . '">Past Order</a>',
									'<a href="' . Url::toRoute(['order/list', 'status' => 'returns']) . '">Returns</a>',
								],
							...
							[
								'label' => 'My Account',
								'content' => [
									'<a href="' . Url::toRoute(['account/index']) . '">Settings</a>',
									'<a href="' . Url::toRoute(['address/list']) . '">Address List</a>',
								],
								'contentOptions' => ['class' => 'in']
							],
							...
							[
								'label' => 'Services',
								'content' => [
									'<a href="'.Url::toRoute(['collect/list']).'">Collection</a>',
									'<a href="'.Url::toRoute(['reviews/list']).'">Reviews</a>',
								],
								'contentOptions' => ['class' => 'in']
							],
						]
